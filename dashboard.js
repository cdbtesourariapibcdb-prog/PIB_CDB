...
// --- nomes exatos das abas (conforme sua planilha)
const SHEETS = {
  entradas: "Entradas",
  saidas: "Saídas",
...
// cabeçalhos esperados (na mesma ordem das colunas da planilha)
const HEADERS = {
...
async function fetchList(action){
  ...
  // API returns JSON array of rows (arrays)
  try {
    const arr = JSON.parse(txt);
    return arr;
  } catch(e){
    console.error('Erro parse JSON:', e, txt);
    throw e;
  }
}
...
async function loadDashboard(){
  try{
    ...
    // fetch arrays-of-arrays from API
    ...
    // convert to objects based on known headers
...
// generate fixed: call API POST generate_fixed
